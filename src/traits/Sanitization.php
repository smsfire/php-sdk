...
trait Sanitization {
   ...
   * @return string
   */
  private static function smsToParameter($data) {
   ...
   * @return string
   */
  private static function smsTextParameter($data) {
   ...
   * @return string
   */
  private static function smsFromParameter($data) {
   ...
   * @return string|null
   */
  private static function smsCustomIdParameter($data) {
   ...
   * @return string|null
   */
  private static function smsCampaignIdParameter($data) {
   ...
   * @return bool
   */
  private static function smsFlashParameter($data) {
   ...
   * @return bool
   */
  private static function smsAllowReplyParameter($data) {
